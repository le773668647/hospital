    ...
    <div class="row ">
        ...
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
            ...
            <div class="panel-body">
                <form id="loginForm" action="<%=basePath%>PatientLogin" method="post">
                    <hr />
                    <h5>输入登陆信息</h5>
                    <br />
                    ...
                    <%--<span onclick="Patientlogin.jsp" class="btn btn-primary col-md-offset-7">注册</span>--%>
                    <button type="button"  onclick="window.location.href='PatientRegister.jsp'" class="btn btn-primary">注册</button>
                    <input type="button" class="btn btn-primary col-md-offset-7" onclick="check()" value="登录"/>
